...
.rounded-video {
            border-radius: 38px; /* Adjust the radius as needed */
            overflow: hidden; /* Ensure the video fits within the rounded border */
    ...
    .d-flex.align-items-start img {
        ...
        /* Align the image at the start (top) of the container */
    }
...
<section class="mb-5" style="margin-top: 100px;">
    <div class="background-image-container" style="background-image: url('assets/img/Ellipse123.jpg');
        ...
        height: 2400px;">
        <div class="container mt-20 " style="padding-left: 120px;">
        ...
        <div class="heading" style="padding-top: 100px;">
            ...
            <div class="container " style="margin-top: 80px;">
                <div class="row justify-content-around ">
                    <div class="col-md-4 col-lg-5" style="margin-right: -70px;padding-top:10px;">
                    ...
                    <div class="col-md-4 col-lg-4" style="width:400px;height:400px;padding-bottom:40px;">
        ...
        <div class="row justify-content-around text-start mt-4">
            ...
            <div class="col-md-4 col-6 row d-flex align-items-center justify-content-center">
            ...
            <div class="col-md-4 col-6 row d-flex align-items-center justify-content-center pt-5">
                <div class="card-img-top text-center">
...
<section class="container-fluid " style="background-color: white;width:100%;margin: 0; padding: 0 !important;margin-bottom: -70px;">
    <div class="" style="">
        <div class="splide">
...
<section class="pb-5" style="background-color:white;">
    ...
    <div class="container" style="position: relative;">
        <div class="" style="position: absolute;left: 47.5%;top:12%;">
...
<section class="pt-5 pb-5" style="background-color:white;">
    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide"><img src="assets/photos/b1.jpg" class="img-fluid" alt="Image 2"></div>
        <div class="swiper-slide"><img src="assets/photos/b2.jpg" class="img-fluid" alt="Image 2"></div>
        <div class="swiper-slide"><img src="assets/photos/b3.jpg" class="img-fluid" alt="Image 4"></div>
        <div class="swiper-slide"><img src="assets/photos/b4.jpg" class="img-fluid" alt="Image 2"></div>
        <div class="swiper-slide"><img src="assets/photos/b5.jpg" class="img-fluid" alt="Image 4"></div>
        <div class="swiper-slide"><img src="assets/photos/b6.jpg" class="img-fluid" alt="Image 2"></div>
