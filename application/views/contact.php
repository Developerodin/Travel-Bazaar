					...
					<div class="row  contact" style="margin: 4rem;justify-content: space-around;">
						...
						<div class="col-md-5">
							<div class="contact-info text-start">
								<h2 class="contact-title  text-start"
									style="    padding-left: 5%;line-height: 1.5;font-weight: 600;color: black; ">
									Contact Us
								</h2>
								<div class="row">
									...
									<h6 class="m-0"
											style="font-weight: 600;color: black; ">
											Phone No.</h6>
										<a href="tel:+61 (03) 91110666"><p style="font-size: 16px;">+61 (03) 91110666</p></a>
									</div>
								</div>
